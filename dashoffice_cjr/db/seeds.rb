...
u1 = User.create!(name: 'Icaro Rezende', email: 'icarorezende@cjr.org.br',
password: 'admin123', admin: false, role_id: r.id, core_id: c.id, active: true)

u2 = User.create!(name: 'Vitor Ribas', email: 'vitorbandeira@cjr.org.br',
password: 'admin123', admin: false, role_id: r.id, core_id: c.id, active: true)
...
ct = Customer.create!(name: 'Bruno Lopes', email: 'vasila1@vasilo.com', phone:
'123456789')
